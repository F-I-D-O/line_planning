...
def process_instance_directory(
    ...
    Candidate lines are always written next to the instance as lines.txt.
    """
    ...
    output_path = instance_dir / "lines.txt"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "For each valid instance directory, a lines.txt file will be generated."
        )
    )
    parser.add_argument(
        "instances_root",
